import { Box,Center,Text,VStack,Grid,Image,GridItem,Flex} from "@chakra-ui/react"
    ...
    return <Box bg="#555555">
        ...
        <Grid  p={5} gridTemplateColumns="repeat(3,1fr)" gap="20px" w="80%" m="auto">
           <GridItem color="white" bg="#252525" pb={5}>
            ...
            <Link style={{color:"#44d62c", padding:"2px"}} to="/pc">Learn More <ChevronRightIcon></ChevronRightIcon></Link>
           </GridItem>
        ...
        <VStack color="#44d62c" bg="#252525" textAlign="center" h={200} alignContent="center">
            ...
            <Text w="60%" p={5} textAlign="center" fontSize={20}>The most powerful rigs mean nothing without the best gear to match. Gain a competitive edge with PC and laptop peripherals armed with our latest technology. From award-winning mice and keyboards to industry-leading headsets and monitors, deck out your setup with our comprehensive selection of peripherals for gaming and work.</Text>
        </VStack>
        ...
        <Box color="white" height="700px" textAlign="left">  
            ...
            <Text fontSize={30} marginTop="-1000px" marginLeft="100px">COMPLETE YOUR SETUP</Text>
            <Text fontSize={20} marginLeft="150px">Best Gaming Laptops</Text>
            <Link style={{color:"#44d62c", padding:"5px",marginLeft:"142px"}}>Learn More <ChevronRightIcon></ChevronRightIcon></Link>
        </Box>

        
        <VStack color="#44d62c" bg="#1a1a1a" textAlign="center" h={250} alignContent="center" p={5} mt="470px"> 
            <Text fontSize={30} >CONTENT CREATION & STREAMING</Text>
            <Text w="60%" p={5} textAlign="center" fontSize={18}>Producing quality content requires quality hardware. From high-fidelity webcams to professional-grade microphones, deliver the best possible streaming experience with our range of content creation gear. Whether you're streaming from your gaming desktop or laptop, we’ve got everything you need to create content that stands out from the rest.</Text>
        </VStack>
        ...
        <VStack color="#44d62c" bg="#1a1a1a" textAlign="center" h={250} alignContent="center" p={5}> 
            ...
            <Text w="60%" p={5} textAlign="center" fontSize={20}>From customizing keybinds and Chroma effects to optimizing audio and game performance, Razer's software platforms are designed to enhance your gaming and productivity. Seamlessly integrated with our extensive collection of gamer accessories and PC peripherals, get the most out of our devices and create a single ecosystem for your gaming or office desktop.</Text>
        </VStack>

        <Grid  p={4} gridTemplateColumns="repeat(3,1fr)" gap="20px" w="80%" m="auto" mb="20px" h="700px" textAlign="left">
            <Box color="white" bg = "#252525" pb="20px" w="100%" h="700px" alignItems="center">
                ...
                <Text p="10px">Bring your desktop to life with high-quality wallpapers that sync with your Razer Chroma™ RGB ecosystem.</Text>
                <Link style={{color:"#44d62c", padding:"10px"}} to="/pc">Learn More <ChevronRightIcon></ChevronRightIcon></Link>
            </Box>
            ...
            <Box color="white" bg = "#252525" pb="20px" w="100%" h="700px" alignItems="center">
                ...
                <Text p="10px">Experience full RGB customization the world’s largest lighting ecosystem that supports hundreds of games and thousands of devices.</Text>
                <Link style={{color:"#44d62c", padding:"10px"}} to="/pc">Learn More <ChevronRightIcon></ChevronRightIcon></Link>
            </Box>
            ...
            <Box color="white" bg = "#252525" pb="20px" w="100%" h="700px" alignItems="center">
                ...
                <Text p="10px">From boosting system performance to discovering gaming deals, enhance your play with one powerful platform.</Text>
                <Link style={{color:"#44d62c", padding:"10px"}} to="/pc">Learn More <ChevronRightIcon></ChevronRightIcon></Link>
            </Box>
        </Grid>
        <Grid  p={5} gridTemplateColumns="repeat(4,1fr)" gap="20px" w="80%" m="auto" textAlign="left">
           <GridItem color="white" bg="#252525" pb={5} w="100%">
            ...
            <Text p="10px">Maximize your unfair advantage with Razer Synapse 3, the unified cloud-based hardware configuration tool that takes your Razer devices to the next level. </Text>
            <Link style={{color:"#44d62c", padding:"10px"}} to="/pc">Learn More <ChevronRightIcon></ChevronRightIcon></Link>
           </GridItem>
           ...
           <GridItem color="white" bg = "#252525" pb={5} w="100%">
            ...
            <Text p="10px">Unlock full customization with a surround sound application featuring more extensive audio calibration and custom-tuned game profiles.Best quality products.</Text>
            <Link style={{color:"#44d62c", padding:"10px"}} to="/pc">Learn More <ChevronRightIcon></ChevronRightIcon></Link>
           </GridItem>
           ...
           <GridItem color="white" bg = "#252525" pb={5} w="100%">
            ...
            <Text p="10px">Experience accurate positional sound for the competitive advantage.The bets version of your capability will come.Best quality is here.Explore by clicking below.</Text>
            <Link style={{color:"#44d62c", padding:"10px"}} to="/pc">Learn More <ChevronRightIcon></ChevronRightIcon></Link>
           </GridItem>
           ...
           <GridItem color="white" bg = "#252525" pb={5} w="100%">
            ...
            <Text p="10px">Put on a show for your stream by customizing how your Seiren Emote or Emote display reacts to your audience.Explore by clicking below and learn more.</Text>
            <Link style={{color:"#44d62c", padding:"10px"}} to="/pc">Learn More <ChevronRightIcon></ChevronRightIcon></Link>
           </GridItem>
        </Grid>

        <Box color="white" height="700px" textAlign="left">  
            <Image src="https://images.unsplash.com/photo-1511512578047-dfb367046420?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1171&q=80" w="100%" h="700px"></Image>
            <Text fontSize={30} marginTop="-400px" marginLeft="100px" color="#44d62c">PLAYTIME. ANYTIME</Text>
